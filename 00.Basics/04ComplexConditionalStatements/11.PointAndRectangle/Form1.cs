...
namespace _11.PointAndRectangle
{
    public partial class FormPointAndRectangle : Form
    {
        ...
        private void Draw()
        {
            ...
            var x1 = this.numericUpDown1.Value;
            var y1 = this.numericUpDown2.Value;
            var x2 = this.numericUpDown3.Value;
            var y2 = this.numericUpDown4.Value;
            var x = this.numericUpDown5.Value;
            var y = this.numericUpDown6.Value;
